/*
September 21st 2020
 * This is GUI class. This frame shows the users that he or she has entered an illogical data.
 */
...
public class UserError extends JFrame implements ActionListener
{
    //Color
    ...
    {
        super("User error");
        this.setBounds(275, 100, 400, 200);
